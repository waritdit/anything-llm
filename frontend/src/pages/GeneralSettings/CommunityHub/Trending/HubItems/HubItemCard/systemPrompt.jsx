    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-theme-text-secondary text-xs bg-zinc-900 light:bg-slate-200 px-2 py-1 rounded-md font-mono border border-slate-800 light:border-slate-300">

  ...
  return (
    <div className="flex flex-col gap-y-1.5">
      ...
      <textarea
        ...
        rows={2}
        className="bg-zinc-800 light:bg-white light:border light:border-slate-300 text-theme-text-primary light:text-slate-700 placeholder:text-zinc-400 light:placeholder:text-slate-400 text-sm rounded-[8px] outline-none block w-full px-3.5 py-2.5 resize-none"
        required
      />
